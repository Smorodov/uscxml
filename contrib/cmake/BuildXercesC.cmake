...
if(MSVC)
	...
	externalproject_add(xerces-c
		...
		BUILD_IN_SOURCE 1
		PREFIX ${CMAKE_BINARY_DIR}/_deps/xerces-c
		CONFIGURE_COMMAND ""
		...
		# INSTALL_COMMAND ${CMAKE_COMMAND} -E copy_directory Build/Win64/${VC_VERSION}/Static\ Release/ ${CMAKE_BINARY_DIR}/_deps/xerces-c/lib/ && ${CMAKE_COMMAND} -E copy_directory src/ ${CMAKE_BINARY_DIR}/_deps/xerces-c/include/
		...
		INSTALL_COMMAND 
			${CMAKE_COMMAND} -E make_directory ${CMAKE_BINARY_DIR}/_deps/xerces-c/lib &&
			...
			${CMAKE_COMMAND} -E copy_directory Build/${XERCESC_BUILD_PATH_SUFFIX}/${VC_VERSION}/Release/ ${CMAKE_BINARY_DIR}/_deps/xerces-c/lib/ && 
			${CMAKE_COMMAND} -E copy ${CMAKE_BINARY_DIR}/_deps/xerces-c/lib/xerces-c_3_1.dll ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/Release/ && 
			${CMAKE_COMMAND} -E copy ${CMAKE_BINARY_DIR}/_deps/xerces-c/lib/xerces-c_3_1.dll ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/Debug/ && 
			${CMAKE_COMMAND} -E copy ${CMAKE_BINARY_DIR}/_deps/xerces-c/lib/xerces-c_3_1.dll ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/ && 
			${CMAKE_COMMAND} -E copy_directory src/ ${CMAKE_BINARY_DIR}/_deps/xerces-c/include/
		)
else()
	externalproject_add(xerces-c
...
set(XercesC_INCLUDE_DIRS ${CMAKE_BINARY_DIR}/_deps/xerces-c/include)

if (APPLE)
	set(XercesC_LIBRARIES ${CMAKE_BINARY_DIR}/_deps/xerces-c/lib/libxerces-c.dylib)
elseif(UNIX)
	set(XercesC_LIBRARIES ${CMAKE_BINARY_DIR}/_deps/xerces-c/lib/libxerces-c.so)
elseif(WIN32)
	# set(XercesC_LIBRARIES ${CMAKE_BINARY_DIR}/_deps/xerces-c/lib/xerces-c_static_3.lib)
	set(XercesC_LIBRARIES ${CMAKE_BINARY_DIR}/_deps/xerces-c/lib/xerces-c_3.lib)
else()
